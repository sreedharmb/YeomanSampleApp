...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <script src="com/vendor/modernizr/modernizr.js"></script>
        <!-- endbuild -->
    </head>
    <body>
        <!--[if lt IE 10]>
        ...
        <div class="container">
            <div class="header">
                ...
                <h3 class="text-muted">YeomanSampleApp</h3>
            </div>
        ...
        <!-- build:js js/main.js -->
        <script data-main="js/main" src="com/vendor/requirejs/require.js"></script>
        <!-- endbuild -->
</body>
</html>
